 ...
 * Usage: node database/run-migration.js database/migrations/007_add_billing_pending_approval_notification_type.sql
 */
...
if (!migrationFile) {
  console.error('Usage: node database/run-migration.js <path-to-migration-file>');
  console.error('Example: node database/run-migration.js database/migrations/007_add_billing_pending_approval_notification_type.sql');
  process.exit(1);
}
