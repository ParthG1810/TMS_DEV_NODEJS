...
--
-- Table structure for table `customer_credit_usage`
--
...
--
-- Table structure for table `customer_name_aliases`
--
...
--
-- Table structure for table `customer_print_order`
--
...
--
-- Table structure for table `delete_authorization_log`
--
...
--
-- Table structure for table `gmail_oauth_settings`
--
...
--
-- Table structure for table `interac_transactions`
--
...
CREATE TABLE `payment_records` (
  ...
  CONSTRAINT `payment_records_ibfk_1` FOREIGN KEY (`interac_transaction_id`) REFERENCES `interac_transactions` (`id`) ON DELETE SET NULL,
...
--
-- Table structure for table `tiffin_calendar_entries`
--
...
--
-- Temporary view structure for view `v_available_for_invoice`
--

DROP TABLE IF EXISTS `v_available_for_invoice`;
/*!50001 DROP VIEW IF EXISTS `v_available_for_invoice`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_available_for_invoice` AS SELECT 
 1 AS `id`,
 1 AS `order_id`,
 1 AS `customer_id`,
 1 AS `customer_name`,
 1 AS `billing_month`,
 1 AS `total_delivered`,
 1 AS `total_absent`,
 1 AS `total_extra`,
 1 AS `total_plan_days`,
 1 AS `base_amount`,
 1 AS `extra_amount`,
 1 AS `total_amount`,
 1 AS `status`,
...
--
-- Temporary view structure for view `v_calendar_entries_detail`
--

DROP TABLE IF EXISTS `v_calendar_entries_detail`;
/*!50001 DROP VIEW IF EXISTS `v_calendar_entries_detail`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_calendar_entries_detail` AS SELECT 
 1 AS `id`,
 1 AS `customer_id`,
 1 AS `customer_name`,
 1 AS `order_id`,
...
--
-- Temporary view structure for view `v_customer_orders_detail`
--

DROP TABLE IF EXISTS `v_customer_orders_detail`;
/*!50001 DROP VIEW IF EXISTS `v_customer_orders_detail`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_customer_orders_detail` AS SELECT 
 1 AS `id`,
 1 AS `customer_id`,
 1 AS `customer_name`,
 1 AS `customer_phone`,
 ...
 1 AS `meal_plan_id`,
 1 AS `meal_name`,
 1 AS `meal_plan_description`,
 1 AS `meal_plan_frequency`,
 1 AS `meal_plan_days`,
 1 AS `quantity`,
 1 AS `selected_days`,
 1 AS `price`,
...
--
-- Temporary view structure for view `v_monthly_billing_summary`
--

DROP TABLE IF EXISTS `v_monthly_billing_summary`;
/*!50001 DROP VIEW IF EXISTS `v_monthly_billing_summary`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_monthly_billing_summary` AS SELECT 
 1 AS `id`,
 1 AS `customer_id`,
 1 AS `customer_name`,
 1 AS `customer_phone`,
...
--
-- Temporary view structure for view `v_monthly_billing_with_balance`
--

DROP TABLE IF EXISTS `v_monthly_billing_with_balance`;
/*!50001 DROP VIEW IF EXISTS `v_monthly_billing_with_balance`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_monthly_billing_with_balance` AS SELECT 
 1 AS `id`,
 1 AS `customer_id`,
 1 AS `customer_name`,
 1 AS `customer_phone`,
...
--
-- Temporary view structure for view `v_pending_payment_invoices`
--

DROP TABLE IF EXISTS `v_pending_payment_invoices`;
/*!50001 DROP VIEW IF EXISTS `v_pending_payment_invoices`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_pending_payment_invoices` AS SELECT 
 1 AS `id`,
 1 AS `customer_id`,
 1 AS `customer_name`,
 1 AS `customer_phone`,
...
--
-- Temporary view structure for view `v_unread_notifications`
--
...
--
-- Dumping events for database 'TmsDb_Dev'
--

--
-- Dumping routines for database 'TmsDb_Dev'
--
...
--
-- Final view structure for view `v_available_for_invoice`
--
...
/*!50001 VIEW `v_available_for_invoice` AS select `ob`.`id` AS `id`,`ob`.`order_id` AS `order_id`,`ob`.`customer_id` AS `customer_id`,`c`.`name` AS `customer_name`,`ob`.`billing_month` AS `billing_month`,`ob`.`total_delivered` AS `total_delivered`,`ob`.`total_absent` AS `total_absent`,`ob`.`total_extra` AS `total_extra`,`ob`.`total_plan_days` AS `total_plan_days`,`ob`.`base_amount` AS `base_amount`,`ob`.`extra_amount` AS `extra_amount`,`ob`.`total_amount` AS `total_amount`,`ob`.`status` AS `status`,`ob`.`finalized_at` AS `finalized_at`,`ob`.`finalized_by` AS `finalized_by`,`mp`.`meal_name` AS `meal_plan_name`,`co`.`price` AS `order_price`,date_format(`co`.`start_date`,'%Y-%m-%d') AS `start_date`,date_format(`co`.`end_date`,'%Y-%m-%d') AS `end_date`,`co`.`selected_days` AS `selected_days` from (((`order_billing` `ob` join `customers` `c` on((`ob`.`customer_id` = `c`.`id`))) join `customer_orders` `co` on((`ob`.`order_id` = `co`.`id`))) join `meal_plans` `mp` on((`co`.`meal_plan_id` = `mp`.`id`))) where ((`ob`.`status` in ('finalized','approved')) and (`ob`.`invoice_id` is null) and ((`co`.`parent_order_id` is null) or (`co`.`parent_order_id` = 0))) order by `ob`.`customer_id`,`ob`.`billing_month`,`mp`.`meal_name` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_calendar_entries_detail`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_calendar_entries_detail` AS select `tce`.`id` AS `id`,`tce`.`customer_id` AS `customer_id`,`c`.`name` AS `customer_name`,`tce`.`order_id` AS `order_id`,`tce`.`delivery_date` AS `delivery_date`,`tce`.`status` AS `status`,`tce`.`quantity` AS `quantity`,`tce`.`price` AS `price`,`co`.`meal_plan_id` AS `meal_plan_id`,`mp`.`meal_name` AS `meal_name`,`tce`.`notes` AS `notes`,`tce`.`created_at` AS `created_at`,`tce`.`updated_at` AS `updated_at` from (((`tiffin_calendar_entries` `tce` join `customers` `c` on((`tce`.`customer_id` = `c`.`id`))) join `customer_orders` `co` on((`tce`.`order_id` = `co`.`id`))) join `meal_plans` `mp` on((`co`.`meal_plan_id` = `mp`.`id`))) order by `tce`.`delivery_date` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_customer_orders_detail`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_customer_orders_detail` AS select `co`.`id` AS `id`,`co`.`customer_id` AS `customer_id`,`c`.`name` AS `customer_name`,`c`.`phone` AS `customer_phone`,`c`.`address` AS `customer_address`,`co`.`meal_plan_id` AS `meal_plan_id`,`mp`.`meal_name` AS `meal_name`,`mp`.`description` AS `meal_plan_description`,`mp`.`frequency` AS `meal_plan_frequency`,`mp`.`days` AS `meal_plan_days`,`co`.`quantity` AS `quantity`,`co`.`selected_days` AS `selected_days`,`co`.`price` AS `price`,`co`.`payment_id` AS `payment_id`,`co`.`payment_status` AS `payment_status`,`co`.`start_date` AS `start_date`,`co`.`end_date` AS `end_date`,`co`.`created_at` AS `created_at`,`co`.`updated_at` AS `updated_at` from ((`customer_orders` `co` join `customers` `c` on((`co`.`customer_id` = `c`.`id`))) join `meal_plans` `mp` on((`co`.`meal_plan_id` = `mp`.`id`))) order by `co`.`created_at` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_invoice_details` AS select `i`.`id` AS `id`,`i`.`invoice_number` AS `invoice_number`,`i`.`customer_id` AS `customer_id`,`c`.`name` AS `customer_name`,`c`.`phone` AS `customer_phone`,`c`.`address` AS `customer_address`,`i`.`invoice_type` AS `invoice_type`,`i`.`total_amount` AS `total_amount`,`i`.`amount_paid` AS `amount_paid`,`i`.`balance_due` AS `balance_due`,`i`.`payment_status` AS `payment_status`,`i`.`generated_at` AS `generated_at`,`i`.`generated_by` AS `generated_by`,`i`.`due_date` AS `due_date`,`i`.`notes` AS `notes`,count(`ob`.`id`) AS `order_count`,group_concat(distinct `ob`.`billing_month` order by `ob`.`billing_month` ASC separator ', ') AS `billing_months` from ((`invoices` `i` join `customers` `c` on((`i`.`customer_id` = `c`.`id`))) left join `order_billing` `ob` on((`ob`.`invoice_id` = `i`.`id`))) group by `i`.`id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_monthly_billing_summary`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_monthly_billing_summary` AS select `mb`.`id` AS `id`,`mb`.`customer_id` AS `customer_id`,`c`.`name` AS `customer_name`,`c`.`phone` AS `customer_phone`,`mb`.`billing_month` AS `billing_month`,`mb`.`total_delivered` AS `total_delivered`,`mb`.`total_absent` AS `total_absent`,`mb`.`total_extra` AS `total_extra`,`mb`.`total_days` AS `total_days`,`mb`.`base_amount` AS `base_amount`,`mb`.`extra_amount` AS `extra_amount`,`mb`.`total_amount` AS `total_amount`,`mb`.`status` AS `status`,`mb`.`calculated_at` AS `calculated_at`,`mb`.`finalized_at` AS `finalized_at`,`mb`.`paid_at` AS `paid_at`,`mb`.`payment_method` AS `payment_method` from (`monthly_billing` `mb` join `customers` `c` on((`mb`.`customer_id` = `c`.`id`))) order by `mb`.`billing_month` desc,`c`.`name` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_monthly_billing_with_balance`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_monthly_billing_with_balance` AS select `mb`.`id` AS `id`,`mb`.`customer_id` AS `customer_id`,`c`.`name` AS `customer_name`,`c`.`phone` AS `customer_phone`,`mb`.`billing_month` AS `billing_month`,`mb`.`total_delivered` AS `total_delivered`,`mb`.`total_absent` AS `total_absent`,`mb`.`total_extra` AS `total_extra`,`mb`.`total_days` AS `total_days`,`mb`.`base_amount` AS `base_amount`,`mb`.`extra_amount` AS `extra_amount`,`mb`.`total_amount` AS `total_amount`,`mb`.`amount_paid` AS `amount_paid`,`mb`.`credit_applied` AS `credit_applied`,((`mb`.`total_amount` - coalesce(`mb`.`amount_paid`,0)) - coalesce(`mb`.`credit_applied`,0)) AS `balance_due`,`mb`.`status` AS `status`,`mb`.`last_payment_date` AS `last_payment_date`,`mb`.`payment_count` AS `payment_count`,`mb`.`calculated_at` AS `calculated_at`,`mb`.`finalized_at` AS `finalized_at`,`mb`.`paid_at` AS `paid_at`,`mb`.`payment_method` AS `payment_method` from (`monthly_billing` `mb` join `customers` `c` on((`mb`.`customer_id` = `c`.`id`))) order by `mb`.`billing_month` desc,`c`.`name` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_pending_payment_invoices`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_pending_payment_invoices` AS select `mb`.`id` AS `id`,`mb`.`customer_id` AS `customer_id`,`c`.`name` AS `customer_name`,`c`.`phone` AS `customer_phone`,`mb`.`billing_month` AS `billing_month`,`mb`.`total_amount` AS `total_amount`,`mb`.`amount_paid` AS `amount_paid`,`mb`.`credit_applied` AS `credit_applied`,((`mb`.`total_amount` - coalesce(`mb`.`amount_paid`,0)) - coalesce(`mb`.`credit_applied`,0)) AS `balance_due`,`mb`.`status` AS `status`,`mb`.`last_payment_date` AS `last_payment_date` from (`monthly_billing` `mb` join `customers` `c` on((`mb`.`customer_id` = `c`.`id`))) where ((`mb`.`status` in ('finalized','partial_paid')) and (((`mb`.`total_amount` - coalesce(`mb`.`amount_paid`,0)) - coalesce(`mb`.`credit_applied`,0)) > 0)) order by (case `mb`.`status` when 'partial_paid' then 1 else 2 end),`mb`.`billing_month` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_unread_notifications`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_unread_notifications` AS select `pn`.`id` AS `id`,`pn`.`notification_type` AS `notification_type`,`pn`.`title` AS `title`,`pn`.`message` AS `message`,`pn`.`priority` AS `priority`,`pn`.`action_url` AS `action_url`,`pn`.`billing_month` AS `billing_month`,`c`.`name` AS `customer_name`,`pn`.`created_at` AS `created_at` from (`payment_notifications` `pn` left join `customers` `c` on((`pn`.`customer_id` = `c`.`id`))) where ((`pn`.`is_read` = false) and (`pn`.`is_dismissed` = false)) order by `pn`.`priority` desc,`pn`.`created_at` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-12-25 19:24:51
