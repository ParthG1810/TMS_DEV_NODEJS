...
export default function MealPlansPage() {
  ...
  const handleEditRow = (id: number) => {
    ...
    push(`/dashboard/meal-plans/${id}/edit`);
  };
      ...
      <Container maxWidth={false}>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: 'Tiffin Management', href: '/dashboard/tiffin' },
            { name: 'Meal Plans' },
          ]}
          action={
            <Button
              ...
              onClick={() => push('/dashboard/meal-plans/new')}
            >
              New Meal Plan
            </Button>
          }
...
// Import missing components for demonstration
