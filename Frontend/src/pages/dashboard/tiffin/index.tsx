...
TiffinDashboardPage.getLayout = (page: React.ReactElement) => <DashboardLayout>{page}</DashboardLayout>;
...
export default function TiffinDashboardPage() {
  ...
  return (
    <>
      <Head>
        <title> Tiffin Dashboard | TMS</title>
      </Head>
      ...
      <Container maxWidth={themeStretch ? false : 'xl'}>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6} md={4}>
            ...
            >
              <CardActionArea onClick={() => router.push(PATH_DASHBOARD.tiffin.billingCalendar)}>
                <CardContent>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    <Box
                      sx={{
                    ...
                    <Box>
                      <Typography variant="subtitle1">Billing Calendar</Typography>
                      <Typography variant="body2" color="text.secondary">
                        Manage billing
                      </Typography>
                    </Box>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card
              sx={{
                bgcolor: alpha(theme.palette.info.dark, 0.08),
                '&:hover': { bgcolor: alpha(theme.palette.info.dark, 0.16) },
              }}
            >
              <CardActionArea onClick={() => router.push(PATH_DASHBOARD.tiffin.billingStatus)}>
                <CardContent>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    <Box
                      sx={{
                        ...
                        height: 64,
                        borderRadius: 2,
                        bgcolor: alpha(theme.palette.info.dark, 0.24),
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                      }}
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card
              sx={{
                ...
                '&:hover': { bgcolor: alpha(theme.palette.success.dark, 0.16) },
              }}
            >
              <CardActionArea onClick={() => router.push(PATH_DASHBOARD.tiffin.invoices)}>
                <CardContent>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    <Box
                      sx={{
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Card
              sx={{
                ...
                '&:hover': { bgcolor: alpha(theme.palette.warning.dark, 0.16) },
              }}
            >
              <CardActionArea onClick={() => router.push(PATH_DASHBOARD.tiffin.settings)}>
                <CardContent>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    <Box
                      sx={{
